...
-   [Get data](#get-data)
-   [Confirm the Hamamatsu-city’s loss in
    dumplings](#confirm-the-hamamatsu-citys-loss-in-dumplings)
-   [Hamamatsu-city lost championship in grilled eel,
    either](#hamamatsu-city-lost-championship-in-grilled-eel-either)
...
-   [Who are the top rank earners in
    2021?](#who-are-the-top-rank-earners-in-2021)
-   [Ranks distribution in each city in
    2021](#ranks-distribution-in-each-city-in-2021)
...
routine news report. In 2021, Hamamatsu-city lost the top rank to
Miyazaki-city
[(Japanese)](https://www.at-s.com/news/article/shizuoka/1023689.html),
...
I list the top earners in 2021. I draw ranks distribution in each city
in 2021. And I argue ranks distribution is partly due to total
...
```
    ...
    ##  $ time  : tibble [37 × 3] (S3: tbl_df/tbl/data.frame)
    ##   ..$ @code : chr [1:37] "1985000000" "1986000000" "1987000000" "1988000000" ...
    ##   ..$ @name : chr [1:37] "1985年" "1986年" "1987年" "1988年" ...
    ##   ..$ @level: chr [1:37] "1" "1" "1" "1" ...
...
```
    ...
    ## Fetching record 1-100000... (total: 599881 records)

    ## Fetching record 100001-200000... (total: 599881 records)

    ## Fetching record 200001-300000... (total: 599881 records)

    ## Fetching record 300001-400000... (total: 599881 records)

    ## Fetching record 400001-500000... (total: 599881 records)

    ## Fetching record 500001-599881... (total: 599881 records)
...
## Confirm the Hamamatsu-city’s loss in dumplings
...
Miyazaki-city won in 2021, but the battle between Hamamatsu-city and
Utsunomiya-city has a long history. Let us draw all available years of
top 10 cities in 2021.
...
## Hamamatsu-city lost championship in grilled eel, either
...
items match speciality goods in each city.
    ...
    ## 19 010800040  343 カステラ             42201 長崎市  
    ## 20 011211010  390 日本そば・うどん     37201 高松市

## Who are the top rank earners in 2021?

In how many items among 488 did each city get the top in 2021?
...
## Ranks distribution in each city in 2021

I draw the histogram that shows each city’s ranks of 488 items in 2021.
